function StockNews() {
    ...
    const news = [
        {
            time: '17 minutes ago',
            source: 'GlobeNewswire • Refinitiv',
            title: 'Itron and Norgesnett Collaborate on First Grid Edge Computing Deployment in Nordics',
        ...
        },
        {
            time: '17 minutes ago',
            source: 'GlobeNewswire • Refinitiv',
            title: 'Oncocyte to Participate in 24th Annual Needham Virtual Healthcare Conference',
            logo: 'https://s3-symbol-logo.tradingview.com/angiodynamics--600.png'
        },
        {
            time: '19 minutes ago',
            source: 'Reuters • Refinitiv',
            title: 'Rivian reports fall in first-quarter deliveries',
        ...
        <div className="py-16 bg-[#060606]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-2xl font-bold">INDIAN stocks news</h2>
                    <a href="#" className="text-primary hover:text-blue-400">See all news</a>
                </div>
                <div className="space-y-4">
                    {news.map((item, index) => (
                        <div key={index} className="bg-dark rounded-lg p-4">
                            <div className="flex items-start space-x-4">
                                <img src={item.logo} alt={item.source} className="w-6 h-6 mt-1" />
